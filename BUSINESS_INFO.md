...
## 5. Website Domain
> TODO: Mr. Lee 한테 확인 필요.

---

## 6. 로고 파일
- `/Users/seonho_kim/Downloads/Eminent_Hospice_Logo_no_back_ground-.svg` (SVG, 투명 배경)
- `/Users/seonho_kim/Downloads/eminentSign.pdf` (PDF 서명용)
- 로고는 eminent-astro 사이트 내에도 존재함.

---

## 7. 환자 가족 추천사 (Google Review)
...
- **설립 연도:** 2018
- **현재 Owner:** Hanna Cha
- **참고:** 설립자는 현재 owner와 다름.
- **설립 배경 참고:** [eminenthospice.com](http://eminenthospice.com) → About Us / Our Mission 페이지 참조.
...
| 연락 방법 | 번호 / 정보 | 운영 시간 |
|---|---|---|
| Direct Phone | (818) 824-3702 | 24/7 |
| Text Only | (213) 340-4429 | 24/7 |

> **참고:** 오피스 운영 시간 외 (월–금, 오전 9시–오후 5시 이후)에는 on-call nurse가 응대합니다.

---

## 10. HIPAA 개인정보 보호 고지서

> TODO: 어떻게 처리할지 추가 논의 필요. (현재 담당자가 요건 파악 중)

---

## 11. 한국어 구사 직원

**거의 모든 직원이 Korean 가능** (일부 직원 제외).
홍보 시 "한국어 이중 언어 케어 제공" 강조 가능.
